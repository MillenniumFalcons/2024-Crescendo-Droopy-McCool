...
public class PivotConstants {
    ...
    public static final double kMaxDegree = 74.3;
    ...
    public static final double kInitialAngle = 74.3;
    ...
    static {
        ...
        kMasterSpeakerMap.put(1.5, 55.2);
        kMasterSpeakerMap.put(1.75, 52.2);
        kMasterSpeakerMap.put(2.0, 48.2);
        kMasterSpeakerMap.put(2.25, 44.2);
        kMasterSpeakerMap.put(2.5, 41.2);
        kMasterSpeakerMap.put(2.75, 39.2);
        kMasterSpeakerMap.put(3.0, 36.2);
        kMasterSpeakerMap.put(3.25, 35.0);
        kMasterSpeakerMap.put(3.5, 33.2);
        kMasterSpeakerMap.put(3.75, 31.7);
        kMasterSpeakerMap.put(4.0, 30.4);
        kMasterSpeakerMap.put(4.25, 28.7);
        kMasterSpeakerMap.put(4.5, 28.1);
        kMasterSpeakerMap.put(5.0, 26.6);
        kMasterSpeakerMap.put(5.5, 25.1);
        kMasterSpeakerMap.put(6.0, 23.4);
        kMasterSpeakerMap.put(6.5, 22.9);
        kMasterSpeakerMap.put(7.0, 22.7);
        kMasterSpeakerMap.put(7.5, 22.4);
        kMasterSpeakerMap.put(8.0, 22.4);
        kMasterSpeakerMap.put(8.5, 22.4);
        kMasterSpeakerMap.put(20.0, 22.4);
