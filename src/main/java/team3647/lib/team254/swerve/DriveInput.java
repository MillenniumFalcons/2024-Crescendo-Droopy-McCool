...
// import team3647.lib.team254.util.LatchedBoolean;
// import team3647.lib.team254.util.TimeDelayedBoolean;
...
//     private LatchedBoolean mShouldEngagePolarDrive = new LatchedBoolean(); // use ToggleBoolean
// above if using gamepad
...
//     public void setDriveInput(double x, double y, double omega, double cardinalHeading, boolean
// shouldSnapToOrigin, boolean shouldEngagePolarDrive) {
//         throttle = x;
//         strafe = y;
//         rotation = omega;
