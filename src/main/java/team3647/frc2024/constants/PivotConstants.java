...
public class PivotConstants {
    ...
    static {
        ...
        kMasterSpeakerMap.put(0.0, 60.0 + 0.2);
        kMasterSpeakerMap.put(1.5, 55.0 + 0.2);
        kMasterSpeakerMap.put(1.75, 52.0 + 0.2);
        kMasterSpeakerMap.put(2.0, 48.0 + 0.2);
        kMasterSpeakerMap.put(2.25, 44.0 + 0.2);
        kMasterSpeakerMap.put(2.5, 41.0 + 0.2);
        kMasterSpeakerMap.put(2.75, 39.0 + 0.2);
        kMasterSpeakerMap.put(3.0, 36.0 + 0.2);
        kMasterSpeakerMap.put(3.25, 34.8 + 0.2);
        kMasterSpeakerMap.put(3.5, 33.0 + 0.2);
        kMasterSpeakerMap.put(3.75, 31.5 + 0.2);
        kMasterSpeakerMap.put(4.0, 30.0 + 0.2);
        kMasterSpeakerMap.put(4.25, 28.3 + 0.2);
        kMasterSpeakerMap.put(4.5, 27.5 + 0.4);
        kMasterSpeakerMap.put(5.0, 26.0 + 0.4);
        kMasterSpeakerMap.put(5.5, 24.5 + 0.4);
        kMasterSpeakerMap.put(6.0, 22.8 + 0.4);
        kMasterSpeakerMap.put(6.5, 22.1 + 0.4 + 0.2);
        kMasterSpeakerMap.put(7.0, 21.6 + 0.4 + 0.4);
        kMasterSpeakerMap.put(7.5, 21.3 + 0.4 + 0.4);
        kMasterSpeakerMap.put(8.0, 21.3 + 0.4 + 0.4);
        kMasterSpeakerMap.put(20.0, 21.3 + 0.4 + 0.4);
