...
public class DrivetrainCommands {
    ...
    public Command lockWheelsForBalance() {
        return Commands.run(() -> swerve.drive(new Translation2d(), 0.1, false, true), swerve);
    }
    ...
    // double ySpeedDemand =
    // Math.abs(ySpeed.getAsDouble()) > 0.3 ? ySpeed.getAsDouble() :
    // 0;
